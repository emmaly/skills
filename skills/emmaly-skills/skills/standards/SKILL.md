...
The `emmaly-skills` plugin provides skills for Go, Svelte, git workflow, integration, project setup, deployment, Home Assistant, and documentation review. Check the available skills list — it is authoritative — and invoke the relevant `emmaly-skills:*` skill when working in those areas.
